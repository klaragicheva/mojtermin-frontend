addEventListener('load',async  () =>{
    ...
    document.getElementById('success').innerText = 'uspesno - You successfully used OpenID Connect and OAuth 2.0 to authenticate.';
});
...
document.getElementById('proba').onclick = async () => {
        console.error('htrhththththt te API');
